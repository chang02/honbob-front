<template>
  <v-layout py-5>
    <toolbar />
    <v-layout justify-center px-5 mt-5>
      <v-flex xs12>
        <v-tabs v-model="tab" centered light>
          ...
          <v-tab-item>
            <v-card class="py-4 px-5" flat>
              ...
              <v-layout row wrap>
                <v-flex xs6 lg3 mr-3 my-3 v-for="(myMatching, key) in myMatchings" v-bind:key="key">
                  <matching-card
                    class="matching-card"
                    :matching="myMatching"
                  />
              ...
              <v-layout row wrap>
                <v-flex xs6 lg3 mr-3 my-3 v-for="(myRequest, key) in myRequests" v-bind:key="key">
                  <matching-card
                    class="matching-card"
